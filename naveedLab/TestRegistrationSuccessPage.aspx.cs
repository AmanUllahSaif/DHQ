...
namespace naveedLab
{
    public partial class TestRegistrationSuccessPage : System.Web.UI.Page
    {
        ...
        protected void btnPrint_Click(object sender, EventArgs e)
        {
            if (hdfID.Value != "0")
            {
                List<sp_CalculateBill_Result> lst = nlDLL.getPatientFinalBill(Convert.ToInt32(hdfID.Value));
